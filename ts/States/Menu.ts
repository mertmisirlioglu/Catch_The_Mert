...
export default class Menu extends Phaser.State {
    ...
    private mert_photo: Phaser.Image;
    private mert_photo_2: Phaser.Image;
    ...
    public create(): void {
        ...
        this.background = this.game.add.image(0, 0, Atlases.Interface, 'bg');

        this.logo = this.game.add.image(0, 0, Atlases.Interface, 'azerion_logo');
        this.logo.anchor.set(0.5);

        this.mert_photo = this.game.add.image(250, 250, Atlases.Interface, 'mert_photo');
        this.mert_photo.anchor.set(0.25);

        this.mert_photo_2 = this.game.add.image(900, 250, Atlases.Interface, 'mert_photo_2');
        this.mert_photo_2.anchor.set(0.25);

        let textStyle: any = {font: 'bold ' + 60 * Constants.GAME_SCALE + 'px Arial', fill: '#ccccff'};
        this.text = new Label(this.game, 0, 0, 'game_title', textStyle);
        textStyle = {font: 'bold ' + 30 * Constants.GAME_SCALE + 'px Arial', fill: '#FFFFFF'};
    ...
    public resize(): void {
        ...
        this.mert_photo.width = 300;
        this.mert_photo.height = 300;

        // this.mert_photo_2.alignIn(this.world.bounds, Phaser.RIGHT_CENTER);
        this.mert_photo_2.width = 300;
        this.mert_photo_2.height = 300;

        this.text.alignIn(this.world.bounds, Phaser.TOP_CENTER);
        this.text.y += 30;
        ...
        this.testGrBtn.alignIn(this.world.bounds, Phaser.CENTER);
        // this.testGrBtn.y += 50;
        // this.testGrBtn.x = this.logo.x + this.logo.x / 2;
        this.testGrBtn.y = this.logo.y + this.logo.height * 0.9;
        ...
        this.moreGamesBtn.alignIn(this.world.bounds, Phaser.CENTER);
        // this.moreGamesBtn.x = this.game.width - this.moreGamesBtn.width * 0.9;
        this.moreGamesBtn.y = this.game.height - this.moreGamesBtn.height;
    }
